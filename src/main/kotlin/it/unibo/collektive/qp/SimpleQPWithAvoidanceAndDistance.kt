...
fun Aggregate<Int>.entrypointWithAvoidanceAndDistance(
    ...
    val velocity = singleRobotToTargetWithAvoidanceAndDistance(robot, target, obstaclePosition, robotsToAvoid, robotsToAvoid,communicationDistance)
 ...
 */
fun singleRobotToTargetWithAvoidanceAndDistance(
    robot: Robot,
    target: Target,
    obstacle: Obstacle,
